...
public class TranscriptWriter extends Writer {
	 ...
	 * <p>
	 * @param premarker  -- A "pre" marker String that acts as a kind of buffer when the test produces too much output.
	 *                      This avoid the marker being "consumed" by the excess output.
	 * @throws IOException 
	 */
	public void mark(String marker) throws IOException {
